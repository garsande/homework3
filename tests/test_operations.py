...
@pytest.mark.parametrize(
    "a, b, expected",
    [
        (4, 10, -6),           # Test subtracting a smaller positive integer from a larger one
        (0, 0, 0),           # Test subtracting two zeros
        (-8, -1, -7),        # Test subtracting a negative integer from another negative integer
        (9.5, 3.5, 6.0),    # Test subtracting two positive floats
...
@pytest.mark.parametrize(
    "a, b, expected",
    [
        (4, 3, 12),           # Test multiplying two positive integers
        (0, 5, 0),          # Test multiplying zero with a positive integer
        (-8, -3, 24),         # Test multiplying two negative integers
...
@pytest.mark.parametrize(
    "a, b, expected",
    [
        (9, 3, 3.0),           # Test dividing two positive integers
        (-6, -2, 3.0),         # Test dividing two negative integers
